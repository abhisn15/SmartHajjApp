...
class TabunganUmroh extends StatefulWidget {
  const TabunganUmroh({Key? key}) : super(key: key);

  @override
  _TabunganUmrohState createState() => _TabunganUmrohState();
}

class _TabunganUmrohState extends State<TabunganUmroh> {
  ...
  Future<List<Map<String, dynamic>>> fetchData() async {
    try {
      String? apiKategoriUmroh = dotenv.env['API_KATEGORI_UMROH'];
      ...
      if (apiKategoriUmroh != null) {
        request = await httpClient.getUrl(Uri.parse(apiKategoriUmroh));
      }
