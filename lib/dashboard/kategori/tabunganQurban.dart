...
class TabunganQurban extends StatefulWidget {
  const TabunganQurban({Key? key}) : super(key: key);

  @override
  _TabunganQurbanState createState() => _TabunganQurbanState();
}

class _TabunganQurbanState extends State<TabunganQurban> {
  ...
  Future<List<Map<String, dynamic>>> fetchData() async {
    try {
      String? apiKategoriQurban = dotenv.env['API_KATEGORI_QURBAN'];
      ...
      if (apiKategoriQurban != null) {
        request = await httpClient.getUrl(Uri.parse(apiKategoriQurban));
      }
                  ...
                  child: FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.connectionState ==
                          ...
                          return Center(
                              child: Text(
                            'Kategori Produk Tabungan Qurban belum tersedia!',
                          ...
                          return Center(
                            child: Text(
                                textAlign: TextAlign.center,
                                'Kategori Produk Tabungan Qurban belum tersedia saat ini.'),
                          );
                        } else {
