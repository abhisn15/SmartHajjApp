  ...
  final List<Map<String, dynamic>> listArtikel = [
    {
      ...
      'category': 'Pesawat Umroh',
      'img': 'assets/home/informasi/pesawatUmroh.jpeg',
      'judul-artikel': 'Wadidawww Sekarang ada yang Menarik di Pesawat Umroh!!',
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => ArtikelPesawatScreen(
