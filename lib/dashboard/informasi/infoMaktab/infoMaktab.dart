...
class InfoMaktab extends StatefulWidget {
  const InfoMaktab({Key? key}) : super(key: key);

  @override
  _InfoMaktabState createState() => _InfoMaktabState();
}

class _InfoMaktabState extends State<InfoMaktab> {
  final List<Map<String, dynamic>> listArtikel = [
    {
      'id': 1,
      'penulis': 'Abhi Surya Nugroho',
      'profile': 'assets/profile/profile.png',
      'category': 'Maktab Mekkah',
      'img': 'assets/home/informasi/maktab.jpeg',
      'judul-artikel': 'Wadidawww Sekarang ada yang Menarik di Maktab Mekkah!!',
    ...
    },
    {
      ...
      'penulis': 'Ilham Rafi',
      'profile': 'assets/profile/profile.png',
      'category': 'Maktab Riyadh',
      'img': 'assets/home/informasi/maktab.jpeg',
      'judul-artikel': 'Wadidawww Sekarang ada yang Menarik di Maktab Riyadh!!',
      'waktu': '1 Menit Yang Lalu',
