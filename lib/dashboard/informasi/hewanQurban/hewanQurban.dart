...
class HewanQurban extends StatefulWidget {
  const HewanQurban({Key? key}) : super(key: key);

  @override
  _HewanQurbanState createState() => _HewanQurbanState();
}

class _HewanQurbanState extends State<HewanQurban> {
  final List<Map<String, dynamic>> listArtikel = [
    {
      'id': 1,
      'penulis': 'Abhi Surya Nugroho',
      'profile': 'assets/profile/profile.png',
      'category': 'Qurban Sapi',
      'img': 'assets/home/informasi/qurbanSapi.jpeg',
      'judul-artikel': 'Alamak Promo Berkah Idul Adha Qurban Sapi Rekk!!',
    ...
    },
    {
      ...
      'img': 'assets/home/informasi/qurbanKambing.jpeg',
      'judul-artikel': 'Alamak Promo Berkah Idul Adha Qurban Kambing Rekk!!',
      'waktu': '1 Menit Yang Lalu',
